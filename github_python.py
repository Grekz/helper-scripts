...
problem_url  = input("Input your url: https://leetcode.com/problems/length-of-last-word/description/") or 'https://leetcode.com/problems/'
problem_type = input("input your problem type: easy") or 'easy'
problem_file = input("E066_PlusOne") or sys.exit('Error: File name needed')
problem_name = input("058. Length of Last Word - Solution.") or sys.exit('Error: Problem name needed')
